        ...
        <>
            <header className="bg-gray-100 mb-14">
                <div className="text-center py-8">
                    <h2 className="mb-6 text-blue text-3xl">Kontakty</h2>
            ...
            <main className="container max-w-[1200px] mx-auto md:px-10 sm:px-8 px-6 mx-auto">
                <section className="mb-10">
                    <h3 className="text-center text-blue mb-7 text-2xl tracking-tight leading-none  md:text-3xl lg:text-4xl">Vedení</h3>
                    <div className="flex flex-wrap justify-between">

                        <div className="flex flex-col items-center shadow rounded-md px-5 py-10">
                            <img className="mb-3 w-24 h-24 rounded-full shadow-lg" src={profilepic} alt="Bonnie image" />
                            <h4 className="mb-1 text-xl font-medium text-blue">Bonnie Green</h4>
                            ...
                            <ul className="text-gray-700 mb-2 mt-4">
                                <li className="hover:text-blue flex mb-2"><svg className="w-6 h-6 text-yellow mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"></path></svg><a href="tel:666666666"> +420 735 489 521</a></li>
                                <li className="hover:text-blue flex mb-2"><svg className="w-6 h-6 text-yellow mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h4.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg><a href="tel:666666666"> +420 735 489 521</a></li>
                ...
                <section className="mb-10">
                    <h3 className="text-center text-blue mb-7 text-2xl tracking-tight leading-none  md:text-3xl lg:text-4xl">Společníci</h3>
                    <div className="flex flex-wrap justify-between">
