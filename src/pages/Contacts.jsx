                    ...
                    <ol className="inline-flex flex-wrap justify-center items-center space-x-1 md:space-x-3 ">
                        ...
                        <li>
                            <div className="flex items-center text-gray-700">
                                ...
                                <a href="#" className="ml-1  inline-flex items-center font-medium hover:underline">Kontakty</a>
                            </div>
                    ...
                    <div className="flex flex-wrap justify-evenly">
                        ...
                        <div className="flex flex-col items-center shadow rounded-md px-5 py-10 my-5 mr-2">
                            ...
                            <ul className="text-gray-700 mb-2 mt-4">
                                <li className="hover:text-uablue flex mb-2"><svg className="w-6 h-6 text-uayellow mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"></path></svg><a href="tel:666666666" className="hover:underline"> +420 735 489 521</a></li>
                                <li className="hover:text-uablue flex mb-2"><svg className="w-6 h-6 text-uayellow mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h4.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg><a href="tel:666666666" className="hover:underline"> +420 735 489 521</a></li>
                                <li className="hover:text-uablue flex mb-2"><svg className="w-6 h-6 text-uayellow mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg><a href="mailto:aaa@aaa.cz" className="hover:underline">zasitua@zasitua.cz</a></li>
                            </ul>
                        </div>
                        <div className="flex flex-col items-center shadow rounded-md px-5 py-10 my-5 mr-2">
                            <a href="/autor/bonnie-green"><img className="mb-3 w-24 h-24 rounded-full shadow-lg" src={profilepic} alt="Bonnie image" /></a>
                            <h4 className="mb-1 text-xl font-medium text-uablue"><a href="/autor/bonnie-green" className="hover:underline">Bonnie Green</a></h4>
                            <span className="text-sm text-gray-500">Visual Designer</span>
