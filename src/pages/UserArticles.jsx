    ...
    return (
        <>
            ...
            <main className="container max-w-[1200px] mx-auto md:px-10 sm:px-8 px-6">
                <section className="mb-10">
                    <div className=" max-w-[860px] mx-auto my-7 bg-white border-bottom md:flex-row md:max-w-xl shadow">
                        <div className="p-4">
                            ...
                            <h3 className="mb-2 text-2xl font-bold tracking-tight text-blue text-center">Pan Autor</h3>
                ...
                <section className="">
                <h3 className="text-center text-blue mb-7 text-2xl tracking-tight leading-none  md:text-3xl lg:text-4xl">Články vybraného autora</h3>
