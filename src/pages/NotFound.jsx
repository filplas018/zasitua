    ...
    return <>
        <header className="bg-gray-100 mb-14">
            <div className="text-center py-8">
                <h2 className="mb-6 text-uablue text-3xl">Nenalezeno</h2>
                <ol className="inline-flex flex-wrap justify-center items-center space-x-1 md:space-x-3 ">
                    ...
                    <li>
                        <div className="flex items-center text-gray-700">
                            ...
                            <a href="#" className="ml-1  inline-flex items-center font-medium hover:underline">Nenalezeno</a>
                        </div>
