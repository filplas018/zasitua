    ...
    return (
        <>
            ...
            <main className="container max-w-[1200px] mx-auto md:px-10 sm:px-8 px-6 mx-auto">
                <h3 className="text-center text-uablue mb-7 text-2xl tracking-tight leading-none  md:text-3xl lg:text-4xl">Chyba</h3>
                <p>
                    Omlouváme se, ale došlo k neočekávanému problému.
                </p>
                <p>Chybové hlášení: {error.message}</p>
            </main>
        </>
    );
}
