                    ...
                    {props.pages.map((element, index) => {
                        <li>
                            <div className="flex items-center">
                                ...
                                <a href={props.links[index]} className="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">{element}</a>
                            </div>
                        </li>
                    })}
